...
if(isset($_POST['login']))
  {
   ...
   // $password=md5($_POST['password']);
    $query=mysqli_query($con,"select ID from users where  id='$id' && password='$password' ");
					...
					<form role="form" action="" method="post" id="" name="login">
						<fieldset>
							<div class="form-group">
								...
								<input class="form-control" placeholder="Id" name="id" type="id" autofocus="" required="true">
							</div>
