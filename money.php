        ...
        <form action="" method="post" enctype="multipart/form-data">
            <table class="table" id="myTable" border="1" bgcolor="#f0ffff">
                ...
                <tr class="success" style="font-weight: bold;" >
                    ...
                    <td>  Full Name :</td>
                    <td>
                        <input type="text" name="name" style="width: 100%;"    align = "center">
                    </td>
                </tr>
                <tr class="success" style="font-weight: bold;" >

                    <td> Father Name :</td>
                    <td><input type="text" id="txt1"   name="fathername" style="width: 100%;"   align="center"></td>
                ...
                <tr class="danger" style="font-weight: bold;">
                    ...
                    <td> Mother Name  :</td>
                    <td><input type="text" id="txt2"  name="mothername" style="width: 100%;"   required ></td>
                </tr>
            </table>
            <table class="table" id="myTable" border="1" bgcolor="#f0ffff">
                <thead>
                ...
                <tr class="success" style="font-weight: bold;">
                    ...
                    <td><input type="text" name="pimsno"  ></td>
                    <td>Home District   :</td>
                    <td><input type="text" name="homezilla"  ></td>
                </tr>
                <tr class="danger" style="font-weight: bold;">
                    <td>Home Upazilla : </td>
                    <td><input type="text" name="homeuzilla"  ></td>
                    <td> Present Post</td>
                ...
                <tr class="success" style="font-weight: bold;">
                    ...
                    <td><input type="text" name="ppostdojoin"  ></td>
                    <td>Date of Birth : </td>
                ...
                <tr class="danger" style="font-weight: bold;">
                    ...
                    <td><input type="text" name="entrypost"  ></td>
                    <td>Date of Fisrt Join (ABAK): </td>
                    <td><input type="text" name="entrydojoin" ></td>
                </tr>

                <tr class="success" style="font-weight: bold;">
                    <td> Highest Degree : </td>
                    <td><input type="text" name="highestdegree"  ></td>
                ...
                <tr class="danger" style="font-weight: bold;">
                    ...
                    <td><input type="text" name="transferdate" > </td>
                </tr>
                ...
                <tr class="success" style="font-weight: bold;">
                    ...
                    <td><input type="text" name="pposting"  ></td>
                    <td>Gender :</td>
                ...
                <tr class="danger" style="font-weight: bold;">
                    ...
                    <td>Matial Status : </td>
                    <td> <input type="text"   name="mstatus"   required> </td>
                </tr>

                <tr class="success" style="font-weight: bold;">
                    <td>Spouse:</td>
                    <td><input type="text"  name="spouse"   required></td>
                    <td>No of Child :</td>
                    <td><input type="text"     name="childno"   required></td>
                </tr>
                <tr class="success" style="font-weight: bold;">
...
<!--<nav class="navbar navbar-inverse">
    <div class="container-fluid">
        ...
        <button class="btn btn-danger navbar-btn"><a href="add.php" style="color:black"   >   Add Personal Info, </a></button>
        <button class="btn btn-danger navbar-btn"><a href="view.php" style="color:black"   >   View </a></button>
        <button class="btn btn-danger navbar-btn"><a href="?logout=true" style="color:black"   >   Logout </a></button>
    </div>
</nav>-->
        ...
        <table class="table" id="myTable" border="1" bgcolor="#f0ffff">
            ...
            <tr class="danger" style="font-weight: bold;">
                ...
                <td><select id="txt6"  name="homeuzilla" >
                        ...
                        <option value="Chittagong Sadar ">Chittagong Sadar</option>
            ...
            <tr class="success" style="font-weight: bold;">
                ...
                <td><select id="txt7" name="ppost" >
                        ...
                        <option value="Deputy Consultant">Deputy Consultant</option>
                        <option value="System Analyst">Sysyem Analyst</option>
                        <option value="Database Administrator">Database Administrator</option>
                        <option value="Asst. System Analyst">Asst. Sysyem Analyst</option>
                        <option value="Asst. Database Administrator">Asst. Database Administrator</option>
                        <option value="Programmer">Programmer</option>
            ...
            <tr class="danger"    style="font-weight: bold;">
                <td>8.</td>
                <td> Date of Joining in Present Post:</td>
                <td><input type="date"   name="ppostdojoin"  ></td>
            </tr>
            <tr class="success" style="font-weight: bold;">
                <td>9.</td>
                <td>Date of Birth : </td>
            ...
            <tr class="success" style="font-weight: bold;">
                <td>11.</td>
                <td>Date of Fisrt Join (ABAK): </td>
                <td><input type="date"   name="entrydojoin"   ></td>
            </tr>
            ...
            <tr class="success" style="font-weight: bold;">
                ...
                <img id="image_upload_preview" src="#" height="100px" width="80px" "/></td>

            </tr>


            <tr class="danger" align="left" >
                <td></td>
                <td></td>
